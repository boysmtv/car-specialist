...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* HERO — putih + orange soft */}
      <section className="hero-soft">
        <div className="container-x grid gap-8 py-10 sm:py-14 lg:grid-cols-2 lg:items-center lg:py-20">
          <div>
            ...
            <div className="mt-6 grid gap-2 sm:flex sm:flex-wrap">
              <Link href="/konsultasi" className="btn-gold w-full sm:w-auto"><CalendarCheck size={17} /> Konsultasi Gratis</Link>
              ...
              <Link href="/layanan" className="btn-ghostlight w-full sm:w-auto">Lihat Layanan</Link>
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-xl">
              ...
              <img src="https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?auto=format&fit=crop&w=1100&q=70" alt="Bengkel Specialist AC Mobil" className="aspect-[4/3] w-full object-cover" />
      ...
      <section className="container-x pb-2">
        <div className="card-luxe grid gap-5 border-orange-200 bg-gradient-to-b from-orange-50 to-white p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
      ...
      {/* FINAL CTA */}
      <section className="container-x py-12">
        <div className="card-luxe grid gap-3 border-orange-200 bg-gradient-to-b from-orange-50 to-white p-8 text-center">
          ...
          <div className="mx-auto grid w-full max-w-md gap-2 sm:flex sm:w-auto sm:flex-wrap sm:justify-center">
            ...
            <Link href="/konsultasi" className="btn-outline w-full sm:w-auto">Konsultasi Gratis</Link>
          </div>
        </div>
      </section>
    </div>
